...
import io.github.zileyuan.umeng_analytics_push.util.NotificationUtil;
...
public class UmengAnalyticsPushPlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        switch (call.method) {
            ...
            case "event":
                event(call, result);
                break;
            case "openPushSetting":
                openPushSetting(call, result);
                break;
            case "isNotifyEnabled":
                isNotifyEnabled(call, result);
                break;
            default:
    ...
    private void openPushSetting(MethodCall call, Result result) {
        NotificationUtil.openSetting(context);
    }

    private void isNotifyEnabled(MethodCall call, Result result) {
        result.success(NotificationUtil.isNotifyEnabled(context));
    }
